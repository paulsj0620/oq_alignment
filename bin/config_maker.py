...
output_cmd_file.write("    --snakefile /TBI/Share/BioPeople/siyoo/Pipelines/kdna_qc_pipeline/Snakemake \\\n")
output_cmd_file.write("    --config 'ref=/TBI/Share/BioPeople/siyoo/Pipelines/kdna_qc_pipeline/refs/ref_kdna.yaml' \\\n")
output_cmd_file.write("    --cluster-config /TBI/Share/BioPeople/siyoo/Pipelines/kdna_qc_pipeline/envs/cluster.json \\\n")
...
output_cmd_file.write("    --cluster 'qsub -V -o ${wkdir}/{cluster.output} -e ${wkdir}/{cluster.error} -pe smp {cluster.threads} -N {cluster.jobName} -S /bin/bash -q kdna.q'\"\n")
